      ...
      <main className='bg-black'>
        <div className='flex justify-center'>
          <div className='max-w-full h-auto'>
            <Image src="/images/ut.png" alt="service" width={1400} height={300} />
          </div>
        </div>
        ...
        <section className='bg-black grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 my-8'>
          <div className='bg-neutral-600 p-4 rounded-lg shadow-md'>
            <div className="flex justify-center space-x-4">
              <Image src="/images/NDT.jpeg" alt="NDT" width={400} height={400} />
              <Image src="/images/ultrasonic.png" alt="ultrasonic" width={400} height={400} />
            </div>
          ...
          <div className='bg-zinc-600 p-4 rounded-lg shadow-md'>
            <div className="flex justify-center">
              <Image src="/images/magnetic.png" alt="magnetic" width={400} height={400} />
            </div>
          ...
          <div className='bg-stone-600 p-4 rounded-lg shadow-md'>
            <div className="flex justify-center">
              <Image src="/images/penetran.png" alt="penetrant" width={400} height={400} />
            </div>
